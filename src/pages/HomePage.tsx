...
export function HomePage() {
    ...
    return <section>
        {
            isError
                ? <span className="flex rounded-md bg-red-500 p-3 text-white">Error occurred</span>
                            ...
                            {isLoading && <p className='p-3'>Loading...</p>}
                            {
                                data
                                    ? data.map(user => (
                                        ...
                                        >
                                            <img src={user.avatar_url} alt={user.login} className='w-6 h-6 mr-4' /> <span>{user.login}</span>
                                        </li>
                                    ))
                                    : null
                            }
